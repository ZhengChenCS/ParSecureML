...
int main(int argc, char **argv){
    ...
    if(MPI_rank == MPI_client){
        ...
        MPI_Send(model1_th1, dim1*dim2, MPI_FLOAT, MPI_server1, 0, MPI_COMM_WORLD);
        ...
        MPI_Send(model1_th2, dim1*dim2, MPI_FLOAT, MPI_server2, 0, MPI_COMM_WORLD);
        ...
        MPI_Recv(model1, dim1*dim2, MPI_FLOAT, MPI_client, 0, MPI_COMM_WORLD, &status);
