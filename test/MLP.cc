/*
This is the source code of MLP
*/
#include <iostream>
#include <fstream>
#include <ostream>
...
int main(int argc, char **argv){
    ...
    if(MPI_rank == MPI_client){
        ...
        */
        ...
        float *model1 = (float*)malloc(sizeof(float)*dim1*dim2);
        ...
        float *model1_th1 = (float*)malloc(sizeof(float)*dim1*dim2);
        float *model1_th2 = (float*)malloc(sizeof(float)*dim1*dim2);
        ...
        int flag2 = -1;
        Support sp1, sp2, sp3;
        sp1.GetShape(batch_size, dim1, dim1, dim2);
        sp1.Initial();
        sp1.Assign();
        ...
        MPI_Send(model1_th1, dim1*dim2, MPI_FLOAT, server1_group_rank, 0, client2server1_comm);
        ...
        MPI_Send(model1_th2, dim1*dim2, MPI_FLOAT, server2_group_rank, 0, client2server2_comm);
        ...
        */
        ...
        MPI_Recv(model1, dim1*dim2, MPI_FLOAT, client_group_rank, 0, client2server_comm, &status);
        ...
        Triplet layer1, layer2, layer3;
    
        layer1.GetShape(batch_size, dim1, dim1, dim2);
        layer1.Initial();
        ...
        for(int i = 0; i+batch_size <= train_size; i+=batch_size){
            ...
            layer1.OP(flag);
            layer1.Activation(server_group_rank, server2server_comm);
